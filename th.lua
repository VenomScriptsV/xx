...
do
    ...
    ThemeManager.BuiltInThemes = {
        ["Default"] = {
            ...
            httpService:JSONDecode(
                [[{"FontColor":"#f0f0f5","MainColor":"#111111","AccentColor":"#79ff7e","BackgroundColor":"#0d0d0d","OutlineColor":"#232323"}]]
            ),
        },
        ["BBot"] = {
            2,
    ...
    function ThemeManager:CreateThemeManager(groupbox)
        ...
        groupbox:AddSlider("GlowTransparency", {
            ...
            Callback = function(val)
                if self.Library.GlowEffect then
                    self.Library.GlowEffect.ImageTransparency = val
                end
            end
        })
